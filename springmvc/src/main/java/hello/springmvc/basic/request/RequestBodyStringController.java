...
public class RequestBodyStringController {
    ...
    public HttpEntity requestBodyString(HttpEntity<String> httpEntity) throws IOException {
    ...
    public HttpEntity requestBodyString(RequestEntity<String> httpEntity) throws IOException {
        String messageBody = httpEntity.getBody();
