...
%>
<%
// String sql = "INSERT INTO tbl_member(memberId, name, pwd) VALUES(?,?,sha2(?, 256))";
...
// jdbc.close();
Map<String, String> registInfo = new HashMap<>();
registInfo.put("memberId", member_id);
registInfo.put("name", name);
registInfo.put("pwd", pwd);

MemberDAO dao = new MemberDAO();
dao.setMemberRegist(registInfo);
